...
<thead>
                                ...
                                <div class="modal fade" id="exampleModa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                       <div class="modal-dialog" role="document">
                                           ...
                                           <span aria-hidden="true">&times;</span>
                                             ...
                                             <form action="{{ route('deleteRole', ['role' => $record->id]) }}" method="post">
                                               @csrf
                                          @method('DELETE')
        ...
        <div class="modal fade" id="exampleMod" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                       <div class="modal-dialog" role="document">
                                           ...
                                           <span aria-hidden="true">&times;</span>
                                               ...
                                               <div class="modal-body">     
                                             <form action="{{ route('deleteAllRoles') }}" method="post">
                                               @csrf
                                          @method('DELETE')
                                       <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="row">
        <div class="col">
            <label for="Name" class="mr-sm-2">roleName:</label>
            <input id="roleName" type="text" name="roleName" accept=".jpg,.jpeg,.bmp,.png,.gif,.doc,.docx,.csv,.rtf,.xlsx,.xls,.txt,.pdf,.zip" class="form-control">
        </div>
    </div>
    <div class="modal-footer">
